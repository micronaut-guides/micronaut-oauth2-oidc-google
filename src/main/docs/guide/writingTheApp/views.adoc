...
To use https://www.thymeleaf.org/[Thymeleaf] Java template engine to render views within a Micronaut application add the following dependency on your classpath. For example, in `build.gradle`
